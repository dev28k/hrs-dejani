...
export default function SingleRoom(props) {
    ...
    useEffect(() => {
        ...
        const i = d.imageLink.split('/');
        setImg("http://localhost:8081/img/" + i[3])
        // console.log(d)
    }, [])
  ...
  return (
    <div>
        ...
        <div class="breadcrumb-area bg-img bg-overlay jarallax" style={{backgroundImage: 'url("img/bg-img/16.jpg")'}}>
                ...
                <div class="row">
                        ...
                        <div class="single-room-details-area mb-50">
                            ...
                            {/* <div class="room-features-area d-flex flex-wrap mb-50">
                                <h6>Class: <span>{data.class}</span></h6>
                                <h6>Capacity: <span>Max persion {data.capacity}</span></h6>
                                <h6>Bed: <span>{data.beds} beds</span></h6>
                                <h6>Services: <span>{data.services}</span></h6>
                            </div> */}
                        ...
                        <div class="hotel-reservation--area mb-100">
                            <form action="#" method="post">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="roberto-btn w-100">Check Available</button>
                                </div>
                            </form>
                        </div>
                    </div>
